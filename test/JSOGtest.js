...
(function() {
  ...
  describe('custom references', function() {
    var decoded, duplicate, encoded, outside;
    duplicate = {
      lorem: 'ipsum'
    };
    outside = {
    ...
    console.log("Decoded is:");
    console.log(JSON.stringify(decoded, void 0, 4));
    it('should be encoded properly when using custom references', function() {
      assert(encoded['@MyId'] != null);
      return assert(encoded['@Id'] == null);
    });
    return it('should be decoded properly when using custom references', function() {
      assert(decoded['@MyId'] == null);
      return assert(decoded['@Id'] == null);
    });
  });
